...
namespace TestSampleWithReact.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.IsAdmin)
            {
                var setRoleResult = await _userManager.AddToRoleAsync(user, "Admin");
                if (!setRoleResult.Succeeded)
                {
                    StatusMessage = "Unexpected error when trying to set admin role.";
                    return RedirectToPage();
                }
            }
            else
            {
                ...
                {
                    StatusMessage = "Unexpected error when trying to remove admin role.";
                    return RedirectToPage();
                }
            }
